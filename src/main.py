...
parser.add_argument('--num_heads', type=int, default=1, help='num_heads of attn')
parser.add_argument('--w', type=float, default=0.3,
                    help='dropout ')
parser.add_argument('--num_layers', type=int, default=2, help='ResFeed_attn_num_layers')
parser.add_argument('--energey_layers', type=int, default=1, help='Energey_Function_layer')   #6
parser.add_argument('--scale', type=float, default=0.1, help='adjust diffusion scale')
parser.add_argument('--eta', type=float, default=0.01, help='trade off parameter eta')
parser.add_argument('--dropout_prob', type=float, default=0.3, help='Energey_layer_dropout_rate')
parser.add_argument('--alpha', type=float, default=0.5, help='control one-step denoising scale')
...
def main(args):    
    ...
    rec_diffu_joint_model = Att_Diffuse_model(AlignDiff, args)
